...
if (!$course = $DB->get_record('course', array('id' => $courseid))) {
  print_error('invalidcourse', 'block_a11y_check', $courseid);
}

$PAGE->set_url('/block/a11y_check/view.php', array('id' => $courseid));
$PAGE->set_pagelayout('standard');
//$PAGE->set_heading(get_string('viewdetailspage', 'block_a11y_check'));
$PAGE->set_heading('A11y Check');
