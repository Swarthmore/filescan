       ...
       */ var r = window.$,
        ...
        i = function(e) {
          var t,
            ...
            a = 0;
          if (e.error)
            for (; a < this.length; a++) (t = this[a]).deferred.reject(e);
          else {
            for (a = 0; a < this.length; a++) {
              if (((t = this[a]), void 0 === (n = e[a]))) {
                l = new Error("missing response");
                break;
              }
              if (!1 !== n.error) {
                (l = n.exception), (r = this[a].nosessionupdate);
                break;
              }
              t.deferred.resolve(n.data);
            }
            null !== l &&
              ("servicerequireslogin" !== l.errorcode || r
      ...
      t.a = {
        call: function(e, t, n, u, c, s) {
          ...
          var y = {
            ...
            g = "service.php",
            b = l.wwwroot + "/lib/ajax/";
          if (
            (n
              ? (b += g + "?sesskey=" + l.sesskey + "&info=" + h)
              : ((b += (g = "service-nologin.php") + "?info=" + h),
                s && ((b += "&cachekey=" + s), (y.type = "GET"))),
            u && (b += "&nosessionupdate=true"),
            "POST" === y.type)
          )
            y.data = d;
          else {
            var w = b + "&args=" + encodeURIComponent(d);
            w.length > 2e3 ? ((y.type = "POST"), (y.data = d)) : (b = w);
          }
          return (
            t
              ? r
                  ...
                  .done(i)
                  .fail(o)
              : ((y.success = i), (y.error = o), r.ajax(b, y)),
            p
          );
        }
      };
      ...
      var r = n(1),
        ...
        s = u.a.forwardRef(function(e, t) {
          ...
          return u.a.createElement(
            p,
            Object(r.a)({ ref: t }, h, {
              className: i()(m, v, s && v + "-" + s, a && "text-" + a)
            }),
            f
          );
        });
...
*/ var r =
      ...
      var r = n(1),
        ...
        s = u.a.forwardRef(function(e, t) {
          var n = e.bsPrefix,
            ...
            s = void 0 === o ? "div" : o,
            f = e.className,
            d = Object(l.a)(e, ["bsPrefix", "fluid", "as", "className"]),
    ...
    function(e, t, n) {
      ...
      function Ql(e) {
        return null === jl ? ((jl = [e]), (Dl = Tl(Ol, ql))) : jl.push(e), Fl;
      }
      function Kl() {
        if (null !== Dl) {
          var e = Dl;
      ...
      function ql() {
        if (!Ll && null !== jl) {
          ...
          try {
            ...
            throw (null !== jl && (jl = jl.slice(e + 1)), Tl(Ol, Kl), t);
          } finally {
            Ll = !1;
          }
        }
      ...
      function za(e) {
        ...
        function p(e, t, n, r) {
          ...
          if ("object" == typeof n && null !== n) {
            ...
            if (_a(n) || X(n)) return null !== l ? null : f(e, t, n, r, null);
            Oa(e, n);
          }
          return null;
        }
        function m(e, t, n, r, l) {
          ...
          if ("object" == typeof r && null !== r) {
            ...
            if (_a(r) || X(r)) return f(t, (e = e.get(n) || null), r, l, null);
            Oa(t, r);
          }
          return null;
        }
      ...
      function di() {
        if (null !== ei)
          (ei = (Ja = ei).next), (Ga = null !== (Xa = Ga) ? Xa.next : null);
        else {
          ...
          (Ja = null === Ja ? (Za = e) : (Ja.next = e)), (Ga = Xa.next);
        }
        return Ja;
      }
      function pi(e, t) {
      ...
      var So,
        Co = Math.ceil,
        Po = R.ReactCurrentDispatcher,
        _o = R.ReactCurrentOwner,
        No = 0,
        Oo = null,
        zo = null,
        Mo = 0,
      ...
      function tu(e, t) {
        ...
        return (
          null !== l && (Oo === l && (du(t), 4 === Ro && Lu(l, Mo)), Au(l, t)),
          l
        );
      }
      function nu(e) {
      ...
      function lu(e, t) {
        if (((Go = 0), t)) return Vu(e, (t = Zo())), ru(e), null;
        var n = nu(e);
        if (0 !== n) {
          ...
          if ((ku(), (e === Oo && n === Mo) || uu(e, n), null !== zo)) {
            ...
            if ((na(), (No = r), (Po.current = l), 1 === Ro))
              throw ((t = Io), uu(e, n), Lu(e, n), ru(e), t);
            if (null === zo)
              switch (
      ...
      function au(e) {
        ...
        if (((t = 0 !== t ? t : 1073741823), e.finishedExpirationTime === t))
          ...
          if ((ku(), (e === Oo && t === Mo) || uu(e, t), null !== zo)) {
            ...
            if ((na(), (No = n), (Po.current = r), 1 === Ro))
              throw ((n = Io), uu(e, t), Lu(e, t), ru(e), n);
              ...
              switch (t.tag) {
                ...
                case 3:
                  Aa(),
                    ...
                    (null === n || null === n.child) && ji(t) && ao(t);
                  break;
                case 5:
                  Wa(t), (r = Da(ja.current));
                  var o = t.type;
                    ...
                    if (ji(t)) {
                      ...
                      switch (
                        ...
                        case "details":
                          ...
                          break;
                        case "input":
                          Pe(r, s), Sn("invalid", r), $n(f, "onChange");
                          break;
                        case "select":
                  ...
                  (a = null !== a),
                    ...
                    a &&
                      ...
                      0 != (1 & $a.current)
                        ? 0 === Ro && (Ro = 3)
                        : ((0 !== Ro && 3 !== Ro) || (Ro = 4),
                          0 !== Do && null !== Oo && (Lu(Oo, Mo), Au(Oo, Do)))),
                    (a || o) && (t.effectTag |= 4);
                  break;
                case 7:
                case 8:
      ...
      function Su(e, t, n) {
        ...
        null !== r && r.delete(t),
          Oo === e && Mo === n
            ? 4 === Ro || (3 === Ro && 1073741823 === Fo && Vl() - Ao < 500)
              ? uu(e, Mo)
              : (Lo = !0)
            : Du(e, n) &&
        ...
        try {
          for (
            ...
            if (null !== o) {
              ...
              (n = t.unstable_now()),
                "function" == typeof u ? (M.callback = u) : M === C(N) && P(N),
                j(n);
            } else P(N);
            M = C(N);
          }
            ...
            u > o
              ? ((e.sortIndex = u),
                ...
                null === C(N) &&
                  e === C(O) &&
                  (U ? a() : (U = !0), l(D, u - o)))
              : ((e.sortIndex = i), S(N, e), F || I || ((F = !0), r(L))),
            e
          );
        }),
    ...
    function(e, t, n) {
      ...
      function p(e, t) {
        ...
        return l.a.createElement(
          ...
          Object(o.a)({ ref: t }, b, {
            ...
            style: Object(o.a)({ width: d(a, r, i) + "%" }, v),
            "aria-valuenow": a,
            "aria-valuemin": r,
            "aria-valuemax": i
          }),
          f ? l.a.createElement("span", { className: "sr-only" }, c) : c
        );
      }
      var m = l.a.forwardRef(function(e, t) {
        var n = e.isChild,
          a = Object(u.a)(e, ["isChild"]);
        if (((a.bsPrefix = Object(f.a)(a.bsPrefix, "progress")), n))
          return p(a, t);
        var i = a.min,
          c = a.now,
          d = a.max,
        ...
        return l.a.createElement(
          ...
          k
            ? (function(e, t) {
                ...
                return Object(r.cloneElement)(e, { isChild: !0 });
              })
            : p(
                {
                  min: i,
      ...
      i.a.render(
        l.a.createElement(function() {
          var e = k(Object(r.useState)(!1), 2),
            t = e[0],
            n = e[1],
            a = k(Object(r.useState)(""), 2),
            i = (a[0], a[1], k(Object(r.useState)(0), 2)),
            o = i[0],
            u = i[1],
            c = k(Object(r.useState)(0), 2),
            s = c[0],
            f = c[1],
            d = k(Object(r.useState)(0), 2),
            p = d[0],
            m = d[1],
            b = k(Object(r.useState)(0), 2),
            E = b[0],
            x = b[1],
            T = k(Object(r.useState)(0), 2),
            S = T[0],
            C = T[1],
            P = function(e, t) {
              return {
                ...
                return regeneratorRuntime.wrap(function(e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return n(!0), (e.next = 3), _();
                      case 3:
                        return (t = e.sent), u(t), (e.next = 7), N(t);
                      case 7:
                        (r = e.sent),
                          (l =
                            r.filter(function(e) {
                ...
                g.a.call([
                  {
                    ...
                    args: P(1, 0),
                      ...
                      var n = t.recordsTotal;
                      e(n);
                    },
                    fail: function() {
                      return t("Could not get total records!");
                    }
                  }
                ]);
              });
                ...
                g.a.call([
                  {
                    ...
                    fail: function() {
                      return n("Could not get total records!");
                    }
                  }
                ]);
              });
            },
            O = { width: "100%", minHeight: "40px" };
          return l.a.createElement(
            y.a,
            { fluid: !0 },
            t &&
              l.a.createElement(
                "div",
                null,
                l.a.createElement(v.a, { animation: "border", role: "status" }),
                l.a.createElement(
                  "span",
        ...
        document.getElementById("afs-progress-bars")
      );
    }
  ]);
});
