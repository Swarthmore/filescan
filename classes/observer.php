...
/**
 * @desc This function is called when a Moodle event may mean we need to update the filescan summary data.
 ...
 */
class block_afs_observer
{
    public static function update(\core\event\base $event)
    {
        $event_data = $event->get_data();
        // Determine if we should invalidate the afs cache
